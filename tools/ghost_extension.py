...
VERSION = "2.0.0"
PROFILE = "Docker and CI/CD policy evidence review"
RULES = [('PIPE-SECRET', 'api[_-]?key|password|token|secret'), ('PIPE-REMOTE', 'ADD\\\\s+https?://|curl\\\\s+.*\\\\|\\\\s*(sh|bash)'), ('PIPE-PERM', 'pull_request_target|permissions:\\\\s*write|sudo')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \_____|_| |_|\____/ \____/_____|
      GHOST-ContainerPipelineGuard v2.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
