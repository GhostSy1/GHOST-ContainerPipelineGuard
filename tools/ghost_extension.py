...
TOOL = "GHOST-ContainerPipelineGuard"
VERSION = "3.0-PRO"
PROFILE = "CI/CD pipeline security and secret leakage guard"
RULES = [('PIPE-SECRET', 'api[_-]?key|password|token|secret'), ('PIPE-REMOTE', 'ADD\\s+https?://|curl\\s+.*\\bsh\\b'), ('PIPE-PERM', 'pull_request_target|permissions:\\s*write|sudo')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-ContainerPipelineGuard v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
